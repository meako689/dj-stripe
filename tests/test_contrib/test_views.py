...
class RestSubscriptionTest(APITestCase):
    ...
    @patch("djstripe.models.Customer.current_subscription", new_callable=PropertyMock, return_value=Subscription(plan=test_plan, amount=Decimal(25.00), status="active"))
    @patch("djstripe.models.Customer.subscribe", autospec=True)
